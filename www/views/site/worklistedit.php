...
<?php $form = ActiveForm::begin(['action' =>['site/worklisteditsave'], 'options' => ['data-pjax' => true ], 'method' => 'post',  'id' => 'form-signup'] ); ?>
...
<br/><br/>
<a href="<?= Url::to(['site/listworktypes', 'type_id'=>$_GET['type']], true); ?>"><?= Html::Button('< к списку', ['id'=>'btn-save', 'class' => 'btn-lg btn-default']) ?> </a>
</div>
</div>
</div>
