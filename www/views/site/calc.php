...
<?php $type=[
	...
	'calcrabica'=> 'Сетка рабица',
	'kalitka' => 'Калитка проф/штак',
	'kalitkarabica'=>'Калитка рабица',
	'vorota' => 'Ворота проф/штак',
	'vorotarabica' => 'Ворота рабица',
...
<h2><a style="color:red" href="/blog.php">Список изменений (Обновлено 21 июля 19:40) </a></h2>
<?php if ($passtrue): ?>	
