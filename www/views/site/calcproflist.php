...
$this->title = 'РАСЧЕТ ЗАБОРА ИЗ ПРОФЛИСТА';
...
<div class="col-xs-2">
<?= $form->field($model,"proflist_nado")->checkbox(); ?>
...
<?=
$form->field($model, 'proflist_type')
    ->dropDownList($model->proflist_type_text,
    [ 'options' => [$model->proflist_type=>['selected' => 'selected']]]
...
<?=
$form->field($model, 'proflist_color')
    ->dropDownList($model->proflist_color_text,
    [ 'options' => [$model->proflist_color=>['selected' => 'selected']]]
...
<div class="col-xs-1">
<?= $form->field($model,"proflist_count")->textInput(['readonly' => 'true']); ?>
</div>
